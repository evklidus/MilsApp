    ...
    var body: some View {
        ...
        VStack(spacing: 5) {
            ...
            Text(value)
                ...
                .foregroundColor(homeVM.darkTheme ? (text == "ккал" ? .pink : .white) : (text == "ккал" ? Color.red.opacity(0.75) : Color.black))
        }
        ...
        .background(homeVM.darkTheme ? Color.init(#colorLiteral(red: 0.1332783699, green: 0.1311504841, blue: 0.136387825, alpha: 1)) : (text == "ккал" ? Color.red.opacity(0.1) : Color.black.opacity(0.075)))
